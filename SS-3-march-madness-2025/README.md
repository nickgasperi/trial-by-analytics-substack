Each file in this repository contains the code used to create an image (or two) displayed in Trial By Analytics' post on Substack titled 'The Most Stacked Final Four Ever?'.
